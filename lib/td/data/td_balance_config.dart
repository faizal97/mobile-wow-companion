...
class TdBalanceConfig {
  ...
  const TdBalanceConfig({
    this.startingLives = 25,
    this.totalWaves = 5,
    this.baseEnemyHp = 200,
    this.baseEnemySpeed = 0.10,
    this.waveHpScalePerWave = 0.2,
    ...
    this.linearPhaseEnd = 10,
    this.linearRate = 0.12,
    this.exponentialBase = 1.96,
    this.exponentialLinear = 0.25,
    this.exponentialQuadratic = 0.05,
    ...
    this.cleanClearThreshold = 20,
    this.standardClearMin = 10,
