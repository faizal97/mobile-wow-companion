...
class TdBalanceConfig {
  ...
  const TdBalanceConfig({
    ...
    this.aoeDamageMult = 0.70,
    this.meleeAttackInterval = 0.8,
    this.rangedAttackInterval = 1.0,
    this.supportAttackInterval = 2.0,
    this.aoeAttackInterval = 0.9,
    this.meleeAttackRange = 0.30,
    this.rangedAttackRange = 0.55,
    this.aoeAttackRange = 0.40,
  ...
  static TdBalanceConfig fromJson(Map<String, dynamic> json) {
    ...
    return TdBalanceConfig(
      ...
      aoeDamageMult: (aoe['damageMult'] as num?)?.toDouble() ?? 0.70,
      ...
      aoeAttackInterval: (aoe['attackInterval'] as num?)?.toDouble() ?? 0.9,
      meleeAttackRange: (melee['attackRange'] as num?)?.toDouble() ?? 0.30,
      rangedAttackRange: (ranged['attackRange'] as num?)?.toDouble() ?? 0.55,
      aoeAttackRange: (aoe['attackRange'] as num?)?.toDouble() ?? 0.40,
